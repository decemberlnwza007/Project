    ...
    <header className="header sticky top-0 bg-white shadow-md flex items-center justify-between px-8 py-2 rounded-xl">
      ...
      <nav className="nav font-semibold text-lg">
        <ul className="flex items-center">
          <li className="p-4 border-b-2 border-orange-500 border-opacity-0 hover:border-opacity-100 hover:text-orange-500 duration-200 cursor-pointer active rounded-lg">
